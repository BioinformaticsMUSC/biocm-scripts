...
plot_scGate <- function(seurat, scGate_model, model_name, save_dir){
...
new_models <- list(BCell = bcell_model, 
                   Endothelial = endothelial_model, 
                   Fibroblast = fib_model, 
                   Granulocyte = gran_model, 
                   Epithelial = epithelial_model, 
                   Mesenchymal = mesenchymal_model)
